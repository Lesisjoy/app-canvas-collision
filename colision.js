...
class Circle {
    constructor(x, y, radius, color, text, speed) {
        ...
        this.isColliding = false; // Agregar colisión
    }

    draw(context) {
        context.beginPath();
        // Cambiar a azul si está en colisión
        context.strokeStyle = this.isColliding ? "#0000FF" : this.color;
        context.fillStyle = 'white'; // Línea del código agregada para poner el texto en blanco.
...
function animate() {
    ...
    // Comprobar colisiones entre círculos
