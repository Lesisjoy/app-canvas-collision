...
//Agregar el color si esta en colision.
context.strokeStyle = this.isColliding ? "#0000FF" : this.color;

//context.strokeStyle = this.color; SE DESABILITA ESTA LINEA DE CODIGO.
context.fillStyle = 'white'; //Linea del codigo agregada para poner el texto en blanco.
...
//Agregamos las lineas de codigo para que se haga la colision.
